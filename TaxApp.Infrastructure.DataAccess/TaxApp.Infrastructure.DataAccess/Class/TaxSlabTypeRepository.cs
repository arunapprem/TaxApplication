...
{
    public class TaxSlabTypeRepository : Repository<TaxSlabTypeMaster>, ITaxSlabTypeRepository
    {
        public TaxSlabTypeRepository(TaxApplicationDbContext context) : base(context)
        {
